...
function res_load(type){
	...
	var app = new Vue({
		...
		data: {
			...
			actions: [{ name: '电视剧' }, { name: '动漫' }, { name: '综艺' }, { name: '记录片' }, { name: '排行榜' }],
		},
		methods: {
			changed(val){
				switch (val.name) {
